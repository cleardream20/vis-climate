...
const temporalModes: { id: TemporalField; label: string; hint: string }[] = [
  { id: 'intrayear', label: '年内', hint: '按月在年内过渡' },
  {
    id: 'annualMax',
    label: '年最高',
    hint: '每年一帧：全国格点平均温最高的日历月',
  },
]

const vizModes: { id: VizMode; label: string; hint: string }[] = [
  { id: 'heatwave', label: '热浪档', hint: '四档离散色带' },
  { id: 'anomaly', label: '距平场', hint: '连续距平色标' },
]

const viewModes: { id: MapViewMode; label: string; hint: string }[] = [
  { id: 'china', label: '中国周边', hint: '聚焦中国及周边' },
  { id: 'global', label: '全球', hint: '全球视角' },
]
    ...
    >
      <div className="min-w-0 flex-1">
        ...
        <p className="truncate text-xs text-slate-400">
          {DOMAIN.yearMin}–{DOMAIN.yearMax} · 9km 网格气候场
        </p>
      </div>
